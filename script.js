...
function putMonthsInOption(name) {
  ...
  for (let i = 0; i < months.length; i++) {
    name.innerHTML += `<option>${months[i]}</option>`
  }
}
...
function getHoroscope() {
  ...
  const monthValue = selectMonth.value.toLowerCase();
  const result = document.querySelector('#result');
  const text = document.querySelector('#text')

  if ( (dayValue >= 22 && monthValue === 'december') || (dayValue <= 19 && monthValue === 'january') ) {
  ...
  } else if ((dayValue >= 20 && monthValue === 'january') || (dayValue <= 18 && monthValue === 'february')) {
  ...
  } else if ((dayValue >= 19 && monthValue === 'february') || (dayValue <= 20 && monthValue === 'march')) {
  ...
  } else if ((dayValue >= 21 && monthValue === 'march') || (dayValue <= 19 && monthValue === 'april')) {
  ...
  } else if ((dayValue >= 20 && monthValue === 'april') || (dayValue <= 20 && monthValue === 'may')) {
  ...
  } else if ((dayValue >= 21 && monthValue === 'may') || (dayValue <= 20 && monthValue === 'june')) {
  ...
  } else if ((dayValue >= 21 && monthValue === 'june') || (dayValue <= 22 && monthValue === 'july')) {
  ...
  } else if ((dayValue >= 23 && monthValue === 'july') || (dayValue <= 22 && monthValue === 'august')) {
  ...
  } else if ((dayValue >= 23 && monthValue === 'august') || (dayValue <= 22 && monthValue === 'september')) {
  ...
  } else if ((dayValue >= 23 && monthValue === 'september') || (dayValue <= 22 && monthValue === 'october')) {
  ...
  } else if ((dayValue >= 23 && monthValue === 'october') || (dayValue <= 21 && monthValue === 'november')) {
...
`
  } else if ((dayValue >= 22 && monthValue === 'november') || (dayValue <= 21 && monthValue === 'december')) {
